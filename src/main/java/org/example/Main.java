...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Factura factura1 = Factura.builder().numero(232).fecha("5/11/2024").build();
            
            Domicilio domicilio1 = Domicilio.builder().nombreCalle("Salvador").numero(321).build();
            Cliente cliente1 = Cliente.builder().nombre("Emiliano").apellido("Caceres").dni(45626123).domicilio(domicilio1).build();
            ...
            System.out.println("No pudo guardarse la clase Factura");}
